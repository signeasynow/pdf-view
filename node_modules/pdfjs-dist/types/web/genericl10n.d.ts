...
export class GenericL10n extends L10n implements IL10n {
     ...
     */
    static "__#48@#generateBundles"(defaultLang: string, baseLang: string): AsyncGenerator<any, void, unknown>;
    static "__#48@#createBundle"(lang: any, baseURL: any, paths: any): Promise<any>;
    static "__#48@#getPaths"(): Promise<{
        baseURL: any;
        paths: any;
    }>;
